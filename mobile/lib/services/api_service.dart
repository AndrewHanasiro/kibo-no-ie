...
class ApiService {
  ...
  static String get productsUrl => baseUrl.isNotEmpty
      ? '$baseUrl/listProducts'
      : 'https://listproducts-veumhwpskq-uc.a.run.app';

  static String get shopsUrl => baseUrl.isNotEmpty
      ? '$baseUrl/listShop'
      : 'https://listshop-veumhwpskq-uc.a.run.app';

  static String get warningsUrl => baseUrl.isNotEmpty
      ? '$baseUrl/listWarning'
      : 'https://listwarning-veumhwpskq-uc.a.run.app';
  ...
  static Future<List<Warning>> getWarnings() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final List<dynamic> jsonList = jsonDecode(response.body);
        final warnings = jsonList
            .map((json) => Warning.fromJson(json))
            .toList();
